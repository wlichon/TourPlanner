...
2. Execute Update-Database command in the package manager console, to create the database using the code-first approach (make sure that the is selected as the default project when doing so).
